call compile preprocessFileLineNumbers "addons\Civilians\Common\Common.sqf";
call compile preprocessFileLineNumbers "addons\Civilians\Common\Debug.sqf";
...
if (isServer) then {
	call compile preprocessFileLineNumbers "addons\Civilians\Server\ServerFunctions.sqf";
	call compile preprocessFileLineNumbers "addons\Civilians\ConfigAndStart.sqf";
};
