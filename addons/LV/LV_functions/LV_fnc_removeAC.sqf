...
LV_deleteOnDestination = compile preprocessFile "addons\LV\LV_functions\LV_fnc_deleteOnDestination.sqf";
LV_killAfterDelay = compile preprocessFile "addons\LV\LV_functions\LV_fnc_killAfterDelay.sqf";
