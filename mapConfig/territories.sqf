...
[
	...
	["TERRITORY_SW_AIRFIELD", "AAC Airfield", 1000, "AIRFIELD", 500],
	...
	["TERRITORY_THRONOS_CASTLE", "Thronos Castle", 500, "OTHER", 200],
	["TERRITORY_IRAKLIA_RUINS", "Iraklia Ruins", 500, "OTHER", 200],
	["TERRITORY_ARTINARKI_RUINS", "Artinarki Ruins", 500, "OTHER", 200],
	["TERRITORY_STADIUM", "Stadium", 750, "OTHER", 250],
	["TERRITORY_XIROLIMNI_DAM", "Xirolimini Dam", 500, "OTHER", 200],
	["TERRITORY_CAMP_NOWHERE", "Camp Nowhere", 500, "OTHER", 1500],

	["TERRITORY_MAGOS_TRANSMITTER", "Magos Transmitter", 500, "TRANSMITTER", 500],
	["TERRITORY_PYRSOS_TRANSMITTER", "Pyrsos Transmitter", 500, "TRANSMITTER", 500],
	["TERRITORY_TRANSMITTER", "Remote Transmitter", 1500, "TRANSMITTER", 300],
	["TERRITORY_SOUTH_TRANSMITTER", "South Transmitter", 500, "TRANSMITTER", 250],
	["TERRITORY_PEFKAS_TRANSMITTER", "Pefkas Transmitter", 500, "TRANSMITTER", 500],
	["TERRITORY_ZAROS_TRANSMITTER", "Zaros Transmitter", 500, "TRANSMITTER", 500],
	...
	["TERRITORY_FRINI_MILITARY_COMPOUND", "Frini Military Compound", 500, "MILITARY", 250],
	["TERRITORY_MILITARY_RESEARCH", "Military Research Compound", 500, "MILITARY", 500],
	["TERRITORY_PYRGOS_MILITARYBASE", "Pyrgos Military Base", 500, "MILITARY", 250],

	["TERRITORY_OILRIG", "Destroyer", 2500, "STRATEGIC", 1000],
	["TERRITORY_CHARKIA_CONTAINER_YARD", "Charkia Container Station", 1500, "STRATEGIC", 1000],
	["TERRITORY_ATHIRA_FACTORY", "Athira Factory", 1000, "STRATEGIC", 750],
	["TERRITORY_HOSPITAL", "Kavala Hospital", 500, "STRATEGIC", 500],
	["TERRITORY_AIRFIELD_DOCKS", "Airfield Docks", 500, "STRATEGIC", 500],
	["TERRITORY_CORE_FACTORY", "Core Production Plant", 1000, "STRATEGIC", 500],
	["TERRITORY_KAVALA_PORT", "Port of Kavala", 1000, "STRATEGIC", 500]
