...
_setupVars =
{
	_missionType = "Heavy HEMTT Convoy";
	_locationsArray = nil;
};
...
_setupObjects =
{
	...
	_convoyVeh = ["B_AFV_Wheeled_01_up_cannon_F","B_Heli_Attack_01_F","B_APC_Tracked_01_rcws_F","B_Truck_01_covered_F","B_APC_Tracked_01_AA_F//"];
