...
_setupObjects =
{
	...
	_missionHintText = format ["<br/>In or around <t size='1.1' color='%1'>%2</t> enemies have been spotted! There seem to be <t color='%1'>%3</t> of them! Catch them, if you can!", occupationMissionColor, _townName, _nbUnits];
};
...
_successExec =
{
	...
	_successHintMessage = format ["Nice work!<br/><br/><t color='%1'>%2</t><br/>is a clean place again!<br/>All Rats are dead!", occupationMissionColor, _townName];
