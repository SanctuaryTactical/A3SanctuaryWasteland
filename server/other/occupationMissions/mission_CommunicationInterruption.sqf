...
_setupObjects =
{
	...
	_missionHintText = format ["<br/>Paramilitary units occupied a <t color='%1'>radio tower</t> to hack the communication on Altis.<br/>Go there, kill these stupid shitheads and clear the area!", occupationMissionColor];
};
...
_successExec =
{
	...
	_cashamountrandomizera = [15000,17500,10000,12500,15000];
	...
	_cashrandomizerb = ["cmoney","cmoney","cmoney","cmoney"];
	_cashamountrandomizerb = [25000,37500,20000,32500,25000];
