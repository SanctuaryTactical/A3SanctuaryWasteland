...
_setupObjects =
{
	...
	_missionHintText = format ["<br/>A group of paramilitary bandits claimed <t size='1.1' color='%1'>%2</t> to their stronghold. Kill these <t color='%1'>%3 bastards</t> and clean the area!", occupationMissionColor, _townName, _nbUnits];
};
...
_successExec =
{
	...
	_successHintMessage = format ["Well done!<br/><br/><t color='%1'>%2</t> has been cleared!<br/>Save the crates and get outa there!", occupationMissionColor, _townName];
