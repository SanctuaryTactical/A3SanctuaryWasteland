...
_setupObjects =
{
	...
	_missionHintText = format ["<br/>The so called Suicide Squad has taken over <br/><t size='1.25' color='%1'>%2</t>.<br/><t color='%1'>%3 of these wankers</t> are lurking in that area. Eliminate them all, claim their cash and drugs stash and clear the area!", occupationMissionColor, _townName, _nbUnits];
};
...
_successExec =
{
	...
	_successHintMessage = format ["<br/><t color='%1'>%2</t><br/> has been cleared.<br/>Hopefully nobody was injured by that fucking explosion ..", occupationMissionColor, _townName];
