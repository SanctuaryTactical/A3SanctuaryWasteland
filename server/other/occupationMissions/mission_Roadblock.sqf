...
_successExec =
{
	...
	{ _x setVariable ["R3F_LOG_disabled", false, true] } forEach [_box1, _barGate, _bunker1, _bunker2, _obj1, _obj2];
	{ _x setVariable ["allowDamage", true, true] } forEach [_barGate, _bunker1, _bunker2, _obj1, _obj2];
