...
_successExec =
{
	...
	_box1 = "Box_NATO_Equip_F" createVehicle getMarkerPos _marker;
    [_box1,"mission_USLaunchers"] call randomCrateLoadOut;
	_box1 allowDamage false;
	
	_box2 = "Box_CSAT_Equip_F" createVehicle getMarkerPos _marker;
    [_box2,"mission_USSpecial2"] call randomCrateLoadOut;
	_box2 allowDamage false;
	
	_box3 = "Box_AAF_Equip_F" createVehicle getMarkerPos _marker;
