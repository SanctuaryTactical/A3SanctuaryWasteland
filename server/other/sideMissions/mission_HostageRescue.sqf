...
_setupObjects =
{
	...
	_missionHintText = format ["<br/>Mercenary soldiers have captured a merchant and claim ransom. <br/> There is <t color='%2'>a crate with 2 Ghillie Suites</t> in it.<br/>Steal the Ghillie Suites <t color='%2'>before</t> you kill every single mercenary!", _vehicleName, sideMissionColor];
};
...
_successExec =
{
	...
	_cashamountrandomizera = [12000,13000,14000,15000,16000,17000];
	...
	_cashamountrandomizerb = [12000,13000,14000,15000,16000,17000];
