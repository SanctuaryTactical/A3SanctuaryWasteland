...
_setupObjects =
{
	...
	_missionHintText = format ["Wake up! A <t color='%2'>%1</t> has been spotted near the marker!<br/> Kill the guards, await the <t color='%2'>paradrop</t> and get one <t color='%2'>UAV Terminal</t>!<br/>", _vehicleName, sideMissionColor];
};
...
_successExec =
{
	...
	//deleteVehicle _vehicle;
	//_vehicle setOwner (owner _playerObject);
