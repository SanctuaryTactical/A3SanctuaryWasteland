...
_setupObjects =
{
	...
	_camonet = createVehicle ["MetalBarrel_burning_F", [_missionPos select 0, _missionPos select 1], [], 0, "CAN COLLIDE"];
    ...
    _hostage addUniform "U_IG_leader";
	waitUntil {alive _hostage};
	[_hostage, "Acts_ExecutionVictim_Loop"] call switchMoveGlobal;
	_hostage disableAI "anim";
	

	_obj1 = createVehicle ["B_G_Offroad_01_F", _missionPos,[], 10,"None"]; 
	...
	_obj3 = createVehicle ["MetalBarrel_burning_F", _missionPos,[], 10,"None"]; 
	...
	_missionHintText = format ["<br/>Bandits stopped a <t color='%2'>Guerilla Offroader</t> and set the driver captive.<br/> They are <t color='%2'>wearing Guerilla uniforms</t>!<br/> Kill these morons and try to keep the real officer alive!", _vehicleName, sideMissionColor];
};
...
_successExec =
{
	...
	_cashamountrandomizera = [12000,16000,18000,20000,22000,24000];
	...
	_cashamountrandomizerb = [12000,16000,18000,20000,22000,24000];
