...
_setupObjects =
{
	...
	_missionHintText = format ["<br/>Deep in the woods, a <t color='%1'>MQ-12 Falcon UAV</t> went down, heavily guarded by special forces. Get there and kill the guards!", sideMissionColor];
};
...
_successExec =
{
	...
	_tent lock 1;
	_tent setVariable ["R3F_LOG_disabled", false, true];
	createVehicleCrew _tent;
