...
_setupVars =
{
	_missionType = "Insurgency Invasion";
...
_setupObjects =
{
	...
	_missionHintText = format ["Some <t color='%2'>%1</t> have been spotted - painted black. <br/>Is this the first evidence for Insurgency on Altis!?", _vehicleName, transportMissionColor];
