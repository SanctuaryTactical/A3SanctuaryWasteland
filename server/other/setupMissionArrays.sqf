...
[
	...
	["mission_HostileHelicopter", .5],
	["mission_HostileJet", 1],
	["mission_HostileVTOL", 1],
	["mission_TripleTrouble", 1],
...
DeepMissionMarkers = (allMapMarkers select {["MayanMission_", _x] call fn_startsWith}) apply {[_x, false]};
...
BridgeConvoyPaths = (call compile preprocessFileLineNumbers "mapConfig\convoys\bridgeConvoysList.sqf") apply {[_x, false]};
CoastalConvoyPaths = (call compile preprocessFileLineNumbers "mapConfig\convoys\coastalConvoysList.sqf") apply {[_x, false]};
SubmarineConvoyPaths = (call compile preprocessFileLineNumbers "mapConfig\convoys\submarineConvoysList.sqf") apply {[_x, false]};
