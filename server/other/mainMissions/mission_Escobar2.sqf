...
_setupObjects =
{
    _missionLocation = ["Race_1", "Race_2", "Race_3", "Race_4", "Race_5", "Race_6"] call bis_fnc_selectRandom;
    _dropLoc1 = ["dropOff_1","dropOff_2","dropOff_3","dropOff_4","dropOff_5","dropOff_6"] call bis_fnc_selectRandom;
