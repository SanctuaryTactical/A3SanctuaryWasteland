...
_setupObjects =
{
	...
	_missionHintText = "A Special Forces armed diving outfit are guarding treasure in a deep underwater Mayan Temple.<br/>Eliminate them to recover the Msytery Treasure. You will need diving gear and an underwater weapon.";
};
