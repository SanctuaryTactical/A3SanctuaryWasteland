...
_setupObjects =
{
	...
	_missionHintText = format ["Two wannabe stars with <t color='%3'>%1</t> try their newbie stunts near the coast. A <t color='%3'>%2</t> escorts and records them.<br/>Kill these bastards! It's Altis, not freaking Hollywood!", _vehicleName, _vehicleName2, waterMissionColor];
