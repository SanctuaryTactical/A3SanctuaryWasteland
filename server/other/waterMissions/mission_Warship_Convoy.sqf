...
private ["_vehChoices", "_convoyVeh", "_veh1", "_veh2", "_veh3", "_veh4", "_createVehicle", "_vehicles", "_leader", "_speedMode", "_waypoint", "_vehicleName", "_vehicleName2", "_vehicleName3", "_vehicleName4",  "_numWaypoints", "_Boxes", "_Box", "_box1", "_Box2", "_box3"];
...
_setupObjects =
{
	...
	_vehChoices =
	[
		["HAFM_Frigate_OPF", "B_Heli_Transport_01_F", "HAFM_Corvette_OPF", "HAFM_PBoat"],
		["A2_Fregata", "O_Heli_Light_02_F", "HAFM_Corvette", "HAFM_CB90"],
		["HAFM_Frigate", "I_Heli_light_03_F", "HAFM_Corvette", "HAFM_MisBoat"]		
	];
	...
	_createVehicle =
	{
		...
		switch (true) do
		{
			case (_type isKindOf "HAFM_Frigate_OPF" || _type isKindOf "A2_Fregata" || _type isKindOf "HAFM_Frigate" || _type isKindOf "HAFM_Corvette_OPF" || _type isKindOf "HAFM_Corvette" || _type isKindOf "HAFM_MisBoat" || _type isKindOf "HAFM_PBoat" || _type isKindOf "HAFM_CB90"):
			{
	...
	_missionHintText = format ["A <t color='%3'>%1</t> warship is patrolling the coast, escorted by a <t color='%3'>%2</t> , <t color='%3'>%3</t> and a  <t color='%3'>%4</t>.<br/>Scupper the fleet to receive a $2,000,000 reward!", _vehicleName, _vehicleName2, _vehicleName3, _vehicleName4, waterMissionColor];
