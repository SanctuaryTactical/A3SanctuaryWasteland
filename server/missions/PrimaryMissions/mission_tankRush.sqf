...
_setupObjects = {
	...
	_missionHintText = format ["A large group of tanks containing at least a <t color='%4'>%1</t>, a <t color='%4'>%2</t> and a <t color='%4'>%3</t> is blizting a random location on the island! Stop the tanks and collect the high value weapons crate and money!", _vehicleName, _vehicleName2, _vehicleName3, PrimaryMissionColor];
