...
_setupObjects = {
    ...
    [_attack, _missionPos vectorAdd ([[random 350, 0, 0], random 250] call BIS_fnc_rotateVector2D), 0, _aiGroup] call STCreateVehicle,
		[_attack, _missionPos vectorAdd ([[random 450, 0, 0], random 300] call BIS_fnc_rotateVector2D), 0, _aiGroup] call STCreateVehicle,
		[_attack, _missionPos vectorAdd ([[random 550, 0, 0], random 350] call BIS_fnc_rotateVector2D), 0, _aiGroup] call STCreateVehicle,
		[_scout, _missionPos vectorAdd ([[random 750, 0, 0], random 400] call BIS_fnc_rotateVector2D), 0, _aiGroup] call STCreateVehicle,
		[_scout, _missionPos vectorAdd ([[random 850, 0, 0], random 450] call BIS_fnc_rotateVector2D), 0, _aiGroup] call STCreateVehicle,
    [_scout, _missionPos vectorAdd ([[random 950, 0, 0], random 500] call BIS_fnc_rotateVector2D), 0, _aiGroup] call STCreateVehicle,
...
_successExec = {
	...
	//Cash
	[_marker, [20000, 40000, 40000,40000,40000, 80000]] call STRandomCashReward;
